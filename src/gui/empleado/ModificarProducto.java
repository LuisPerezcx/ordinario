...
public class ModificarProducto extends JFrame implements ItemListener {
    ...
    private int index;
    public ModificarProducto(int index){
        this.index=index;
        initComponents();
        initFrame();
        setPnlContenedor();
    ...
    private void setPnlContenedor(){
        ...
        pnlContenedor.add(new JLabel());
        pnlContenedor.add(btnActualizar);
    ...
    private void modificarProducto() {
        ...
        productoArrayList.set(index,new Producto(nombre,marca,nExistencias,descripcion,precio,departamento1));
        clear();
    }
    private void clear(){
        txtNombre.setText("");
